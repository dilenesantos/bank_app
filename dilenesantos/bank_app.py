...
if selected == 'Introduction':  
    ...
    st.write("Ces colonnes nous fournissent 4 types d'informations :")
    st.write("") 
...
if selected == "Modélisation":
    ...
    if page == pages[0] : 
        ...
        st.write("Nous avons effectué **deux modélisations**, l'une en **conservant la variable Duration** et **l'autre sans la variable Duration** : on explique pourquoixxxxxxx blablabla.")
    ...
    if page == pages[1] : 
        ...
        if submenu_interpretation == "ANALYSE DES VARIABLES LES PLUS IMPORTANTES" :
            ...
            if submenu_local == "ÂGE" :
                ...
                # Générer le graphique de dépendance avec les vraies valeurs
                ...
                # Configurez les limites et les ticks de l'axe x
                ax.set_xlim(17, 76)  # Limites des âges
                ax.set_xticks(np.arange(17, 77, 1))  # Ticks pour chaque année
