...
if selected == "Modélisation":
    ...
    if page == pages[0] : 
        ...
        st.write("Nous avons effectué **deux modélisations**, l'une en **conservant la variable Duration** et **l'autre sans la variable Duration** : on explique pourquoi blablabla.")
